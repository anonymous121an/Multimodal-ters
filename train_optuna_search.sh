...
#SBATCH --array=0-3
#SBATCH -o /scratch/phys/sin/sethih1/Multimodal-ters/slurm_logs_optuna/optuna_%a_%A.out
#SBATCH -e /scratch/phys/sin/sethih1/Multimodal-ters/slurm_logs_optuna/optuna_%a_%A.err
#SBATCH --job-name=multimodal_optuna
...
log_dir="$script_dir/slurm_logs_optuna"
optuna_dir="$script_dir/optuna_studies"
checkpoint_dir="$script_dir/model_checkpoints/optuna/optuna_${FUSION_TYPE}"
...
WANDB_PROJECT=${WANDB_PROJECT:-multimodal-ters-optuna}
...
python "$script_dir/train_multimodal_optuna.py" \
    ...
    --config "$script_dir/src/configs/optuna_search.yaml"
