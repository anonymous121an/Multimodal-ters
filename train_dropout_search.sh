...
#SBATCH --array=0-3
#SBATCH -o /scratch/phys/sin/sethih1/Multimodal-ters/slurm_logs_optuna_dropout/optuna_%a_%A.out
#SBATCH -e /scratch/phys/sin/sethih1/Multimodal-ters/slurm_logs_optuna_dropout/optuna_%a_%A.err
#SBATCH --job-name=optuna_dropout

# =============================================================================
# Multimodal TERS — Optuna Search with Dropout
#
# Same structure as train_optuna_search_spectral_cnn.sh but adds
# bottleneck_dropout_p as a hyperparameter (0.0-0.5) to force the model
# to rely more on frequency information.
#
...
#
# Usage:
#   sbatch train_dropout_search.sh
# =============================================================================
...
echo "Dropout:         bottleneck_dropout_p [0.0, 0.5]"
...
log_dir="$script_dir/slurm_logs_optuna_dropout"
optuna_dir="$script_dir/optuna_studies_dropout"
checkpoint_dir="$script_dir/model_checkpoints/optuna_dropout/optuna_${FUSION_TYPE}"
...
# --- WandB ---
WANDB_PROJECT=${WANDB_PROJECT:-multimodal-ters-optuna-dropout}
...
python "$script_dir/train_multimodal_optuna.py" \
    ...
    --config "$script_dir/src/configs/optuna_search_dropout.yaml"
